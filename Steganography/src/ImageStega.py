...
class ImageStega:
    ...
    def encode(self, msg, output_path):
        ...
        new_img = encode_msg(new_img, msg)
        new_img.save(output_path, 'PNG')

    def decode(self):
        msg = decode_msg(self.IMG)
        print(msg)

def main():
    #img_st = ImageStega('../dat/img.png')
    #img_st.encode('Hello RaffaDNDM!', '../dat/encoded_img.png')
